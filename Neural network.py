...
time_4 = time()
print('training the model cost '+ str(time_4 - time_3)+' second')
...
print(accuracy)
time_6 = time()
print('Getting the test label and accuracy cost '+ str(time_6 - time_5)+' second')
...
time_7 = time()
print('The whole process cost '+ str(time_7 - time_1)+' second')
